...
const tmpDir = path.join(repoRoot, "tmp_ueblueprint");
const testsDir = path.join(tmpDir, "tests");

if (!fs.existsSync(testsDir)) {
  console.error("tests/ folder not found inside tmp_ueblueprint. Clone https://github.com/barsdeveloper/ueblueprint into tmp_ueblueprint first.");
  process.exit(1);
}
...
const outPathTs = path.join(repoRoot, "blueprint-vibe", "src", "ue", "nodeCatalog.generated.ts");
fs.mkdirSync(path.dirname(outPathTs), { recursive: true });
